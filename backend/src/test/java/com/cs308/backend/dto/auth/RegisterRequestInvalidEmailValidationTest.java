...
class RegisterRequestInvalidEmailValidationTest {

    @Test
    void rejectsInvalidRegisterEmail() {
        try (ValidatorFactory factory = Validation.buildDefaultValidatorFactory()) {
            Validator validator = factory.getValidator();
            RegisterRequest request = new RegisterRequest("Test", "User", "not-an-email", "", "secret123");
